...
import { expenseService, categoryService, Category } from '../services/firebaseService';
...
export default function ExpenseForm({ visible, onClose, onSuccess }: ExpenseFormProps) {
  ...
  return (
    ...
    >
      <View className={`flex-1 ${isDark ? 'bg-gray-900' : 'bg-gray-50'}`}>
        {/* Header */}
        <View className={`px-6 py-4 border-b ${isDark ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-white'}`}>
        ...
        <ScrollView className="flex-1 px-6 py-6">
          ...
          <View className="mb-6">
            ...
            <View className={`flex-row items-center p-4 rounded-2xl ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
          ...
          {amount && title && selectedCategory && (
            <View className={`p-4 rounded-2xl ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
              ...
              <View className="flex-row items-center">
                <View className={`p-2 rounded-full mr-3 ${selectedCategory.color}`}>
                  <Ionicons
                ...
                <Text className={`text-lg font-bold ${isDark ? 'text-red-400' : 'text-red-500'}`}>
                  -Rp {amount}
                </Text>
              </View>
            </View>
